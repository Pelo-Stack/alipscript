...
const instagram = 'belum punya instagram'; 
const telegram = 'masih tahap download'; 
const kapanbotaktif = 'KETIKA ADA TULISAN DI INFO WA SAYA (BOT ON✅) BERARTI SAYA ON'; 
const youtube = 'https://www.youtube.com/channel/UCZTUYmFg7nGWaICg1Lz3k4g';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Youtube: AnggorGAMEP')
